...
class MainActivity:Activity(){
 ...
 private fun addUi(root:FrameLayout){
  ...
  head.addView(sat,LinearLayout.LayoutParams(dp(112),dp(40)).apply{marginStart=dp(8)})
  val voice=TextView(this).apply{text="🎙";textSize=17f;gravity=Gravity.CENTER;background=bg(Color.rgb(42,50,66),20);setOnClickListener{startActivity(android.content.Intent(this@MainActivity,VoiceMonitorActivity::class.java))}}
  head.addView(voice,LinearLayout.LayoutParams(dp(40),dp(40)).apply{marginStart=dp(8)});root.addView(head,FrameLayout.LayoutParams(-1,dp(56),Gravity.TOP))
